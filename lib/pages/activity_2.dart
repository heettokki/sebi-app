...
class Activity2Page extends StatefulWidget {
  ...
  const Activity2Page({super.key, required this.phrases});
...
class _Activity2PageState extends State<Activity2Page> {
  ...
  final List<List<String>> choicesList = [
    ["Salamat", "Walay sapayan", "Pasaylo-a ko", "Ekskyus"],
    ["Walay sapayan", "Salamat", "Palihug", "Oo"],
    ["Pasaylo-a ko", "Ekskyus", "Salamat", "Dili"],
    ["Ekskyus", "Pasaylo-a ko", "Oo", "Dili"],
    ["Palihug", "Oo", "Dili", "Amping"],
    ["Oo", "Dili", "Palihug", "Maayong trabaho"],
    ["Dili", "Oo", "Amping", "Maayong trabaho"],
    ["Maayong trabaho", "Amping", "Panalanginan ka", "Walay sapayan"],
    ["Amping", "Panalanginan ka", "Maayong trabaho", "Salamat"],
    ["Panalanginan ka", "Amping", "Maayong trabaho", "Salamat"],
  ];
